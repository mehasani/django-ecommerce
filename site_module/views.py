...
from site_module.models import FooterLinkBox, SiteSetting
...
def site_header_component(request):
    ...
    context = {"loggedin_user": loggedin_user, "site_setting": setting}
...
def site_footer_component(request):
    ...
    if cache.get("footer_link_boxes"):
        ...
        footer_link_boxes: FooterLinkBox = FooterLinkBox.objects.all().prefetch_related(
            "footerlink_set"
        )
